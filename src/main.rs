use micro_sp::*;
use r2r_transforms::*;
use r2r_ur_controller::ros::dashboard_client::dashboard_client;
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    transform_buffer.insert_transform("base_in_world", base_in_world);
    transform_buffer.insert_transform("a_in_world", a_in_world);
    transform_buffer.insert_transform("b_in_world", b_in_world);
